...
class TestLateEnvRepointScopesStore:
    ...
    def test_late_env_repoint_scopes_store(self, tmp_path, monkeypatch):
        ...
        # The suite-wide conftest deliberately repoints the module constants
        # (the documented process-wide escape hatch), and that branch takes
        # precedence over a late HERMES_HOME by design. Restore the
        # import-time constants so this test exercises exactly the
        # late-env-repoint branch it documents.
