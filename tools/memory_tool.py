...
MEMORY_BLOCK_HEADERS = {
    ...
    # Fork: SELF-Block (TARS-Persona) — bei Upstream-Merges erhalten.
    "self": "SELF (who you are, how you've changed)",
}
...
class MemoryStore:
    ...
    def _render_block(self, target: str, entries: List[str]) -> str:
        ...
        if target == "user":
            ...
            header = f"{MEMORY_BLOCK_HEADERS['self']} [{pct}% — {current:,}/{limit:,} chars]"
        else:
