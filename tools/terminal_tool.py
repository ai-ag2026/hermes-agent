...
def _get_env_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "docker_mount_agent_assets": os.getenv("TERMINAL_DOCKER_MOUNT_AGENT_ASSETS", "true").lower() in {"true", "1", "yes"},
...
def _create_environment(env_type: str, image: str, cwd: str, timeout: int,
    ...
    if env_type == "local":
        ...
        return _DockerEnvironment(
            ...
            mount_agent_assets=cc.get("docker_mount_agent_assets", True),
