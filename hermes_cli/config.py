...
DEFAULT_CONFIG = {
    ...
    "terminal": {
        ...
        # Mount profile credential files, skills and media caches into Docker.
        # Disable for untrusted autonomous workers: read-only still exposes
        # host-side control-plane material to the container.
