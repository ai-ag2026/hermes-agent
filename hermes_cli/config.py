...
# fork(tars) 30.07.2026: Overlay statt eigener DEFAULT_CONFIG-Kopie.
# Upstream hat den Dict nach hermes_cli/config_defaults.py ausgelagert. Eine
# gespiegelte Kopie an dieser Stelle hat bei diesem Merge über 2600 Zeilen
# kollidiert — und hätte es bei jedem weiteren wieder getan. Der Vergleich
# beider Fassungen ergab acht eigene Schlüssel; die kamen zu upstreams Werten
# hinzu. Zwei WERTE wichen zusätzlich ab (agent.max_turns 90 statt 500,
# tools.tool_search.threshold_pct 10 statt 5) — Manfred-Entscheid 30.07.:
# upstream übernehmen. Sie stehen deshalb bewusst NICHT hier.
_FORK_DEFAULTS = {
    "checkpoints": {"delete_orphans": True},
    "terminal": {"docker_mount_agent_assets": True},
    "kanban": {
...
def _overlay(base: dict, extra: dict) -> None:
    """Deep-merge *extra* into *base* in place (dicts recurse, leaves win)."""
...
_overlay(DEFAULT_CONFIG, _FORK_DEFAULTS)
...
TERMINAL_CONFIG_ENV_MAP = {
    ...
    "docker_mount_agent_assets": "TERMINAL_DOCKER_MOUNT_AGENT_ASSETS",
