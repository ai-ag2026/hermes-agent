...
CODING_AGENT_GUIDANCE = (
    ...
    "\n"
    "Respect the user's repo: ordinary commits and PRs to your own or working "
    "repos are a normal part of finishing — do them; only rewriting shared "
    "history, force-pushing, or pushing to third-party/upstream repos needs the "
    "user's ok. Never read, print, or commit secrets — leave `.env` and "
