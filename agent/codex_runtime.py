    ...
    * ``commentary_as_text`` — when True, ``commentary``/``analysis``-phase
    ...
    for event in event_iter:
        ...
        if "output_text.delta" in event_type or event_type == "response.output_text.delta":
            ...
            # MERGE (Rehearsal 23.07.): Upstreams First-Class-Commentary-Kanal
            # + unser commentary_as_text-Flag (Qwopus). Flag False = Upstream-
            # Verhalten; Flag True = commentary/analysis fallen in den
            # sichtbaren Textzweig (elif delta_text unten).
            if delta_text and active_message_phase == "commentary" and not commentary_as_text:
            ...
            elif delta_text and active_message_phase == "analysis" and not commentary_as_text:
