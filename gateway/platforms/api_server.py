...
class APIServerAdapter(BasePlatformAdapter):
    ...
    async def _handle_chat_completions(self, request: "web.Request") -> "web.Response":
        ...
        if rabbit_result is not None:
            ...
            # fork(tars): nur der rabbit-Zweig ist unser. Die Schlüsselliste ist
            # upstreams — sie nimmt zusätzlich provider und model_options auf und
            # ist damit eine echte Obermenge unserer alten Liste.
    ...
    async def _handle_runs(self, request: "web.Request") -> "web.Response":
        ...
        # fork(tars): upstream hat an dieser Stelle die Route-/Override-Pruefung
        # gebaut, NICHT dasselbe — beides bleibt, unsere Kurzschluss-Pruefung
        # zuerst, damit ein Replay gar nicht erst in die Routenaufloesung laeuft.
